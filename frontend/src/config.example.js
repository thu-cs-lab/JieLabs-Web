...
export const BOARDS = {
  default: {
    ...
    pins: [
      ...
      { pin: 'PIN_M25',  input: true, output: true,  clock: false, label: 'IO16' },
      { pin: 'PIN_AC24', input: true, output: true,  clock: false, label: 'IO19' },
      { pin: 'PIN_Y22',  input: true, output: true,  clock: false },
      { pin: 'PIN_AB24', input: true, output: true,  clock: false, label: 'IO1' },
      { pin: 'PIN_AB23', input: true, output: true,  clock: false, label: 'IO4' },
      { pin: 'PIN_AA24', input: true, output: true,  clock: false, label: 'IO7' },
      { pin: 'PIN_AA23', input: true, output: true,  clock: false, label: 'IO15' },
      { pin: 'PIN_AC25', input: true, output: true,  clock: false, label: 'IO18' },
