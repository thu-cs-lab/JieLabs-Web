...
export const BOARDS = {
  default: {
    ...
    pins: [
      ...
      { pin: 'PIN_L23',  input: true, output: true,  clock: false, label: 'IO6' },
      { pin: 'PIN_M22',  input: true, output: true,  clock: false, label: 'IO5' },
      { pin: 'PIN_J25',  input: true, output: true,  clock: false, label: 'IO4' },
      { pin: 'PIN_J26',  input: true, output: true,  clock: false, label: 'IO14' },
      { pin: 'PIN_K25',  input: true, output: true,  clock: false, label: 'IO8' },
      { pin: 'PIN_M24',  input: true, output: true,  clock: false, label: 'IO7' },
      { pin: 'PIN_M23',  input: true, output: true,  clock: false, label: 'IO17' },
      { pin: 'PIN_K26',  input: true, output: true,  clock: false, label: 'IO16' },
      { pin: 'PIN_L25',  input: true, output: true,  clock: false, label: 'IO15' },
      { pin: 'PIN_N24',  input: true, output: true,  clock: false, label: 'IO21' },
      { pin: 'PIN_N23',  input: true, output: true,  clock: false, label: 'IO20' },
      { pin: 'PIN_M25',  input: true, output: true,  clock: false, label: 'IO19' },
      { pin: 'PIN_AC24', input: true, output: true,  clock: false, label: 'IO18' },
